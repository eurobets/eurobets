export default {
    ...
    'Teams.name.FC Basel': 'Базель',
    'Teams.name.Ludogorez Rasgrad': 'Лудогорец',
    'Teams.name.SL Benfica': 'Бенфика',
    'Teams.name.Besiktas JK': 'Бешикташ',
    'Teams.name.PSV Eindhoven': 'ПСВ Эйндховен',
    'Teams.name.Club Atlético de Madrid': 'Атлетико Мадрид',
    'Teams.name.Manchester City FC': 'Манчестер Сити',
    'Teams.name.Bor. Mönchengladbach': 'Боруссия М',
    'Teams.name.Dynamo Kyiv': 'Динамо Киев',
    'Teams.name.SSC Napoli': 'Наполи',
    'Teams.name.Paris Saint-Germain': 'ПСЖ',
    'Teams.name.Arsenal FC': 'Арсенал',
    'Teams.name.FC Bayern München': 'Бавария',
    'Teams.name.Real Madrid CF': 'Реал Мадрид',
    'Teams.name.Sporting CP': 'Спортинг',
    'Teams.name.Juventus Turin': 'Ювентус',
    'Teams.name.Sevilla FC': 'Севилья',
    'Teams.name.FC Rostov': 'Ростов',
    'Teams.name.Leicester City FC': 'Лестер',
    'Teams.name.Club Brugge': 'Брюгге',
    'Teams.name.Legia Warszawa': 'Легия',
    'Teams.name.Borussia Dortmund': 'Боруссия',
    'Teams.name.Olympique Lyonnais': 'Лион',
    'Teams.name.Bayer Leverkusen': 'Байер',
    'Teams.name.GNK Dinamo Zagreb': 'Динамо Загреб',
    'Teams.name.CSKA Moscow': 'ЦСКА Москва',
    'Teams.name.Tottenham Hotspur FC': 'Тоттенхэм',
    'Teams.name.AS Monaco FC': 'Монако',
    'Teams.name.FC Porto': 'Порту',
    'Teams.name.FC Barcelona': 'Барселона',
    'Teams.name.Celtic FC': 'Селтик',
    'Teams.name.FC Copenhagen': 'Копенгаген'
